...
```
_See premium tier for intervention formulas._
```
...
|---------|-----------|----------------|------------------|
| Infrastructure-Cognitive Spiral | PHY + PSY declining | Physical (stabilize infra) | PHY ↑ → PSY ↑ → INT ↑ → SOC ↑ |
| Performance-Cost Decline | VOC + FIN declining | Vocational (small wins) | VOC ↑ → SPI ↑ + INT ↑ + FIN ↑ |
| Collaboration Breakdown | SOC dropping | Social (handoff quality) | SOC ↑ → PSY ↑ + SPI ↑ |
| Full-System Decline (3+ dims) | Multiple dims below threshold | Psychological (hub dim) | Broadest cascade. |
