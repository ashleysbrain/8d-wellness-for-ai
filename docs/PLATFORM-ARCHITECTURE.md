...
```json
{
  ...
  "independence_constraints": {
    ...
    "no_self_scoring": "scored by Fleet Health Officer only",
    "no_score_modification": "recommends only, Fleet Health Officer or agent applies",
    "rotation": "VITALS itself is audited by Fleet Health Officer monthly"
  }
}
```
