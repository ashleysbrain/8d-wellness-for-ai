...
```
D_final(i) = weighted blend of D_objective(i) + D_peer(i) + D_self(i). _See premium tier for weights._
```
...
If |SelfScore - ObjectiveScore| > 2.0:
    D_final(i) = reweighted blend (see premium tier for adjusted weights)
...
The coupling term captures cross-dimensional interactions that traditional scoring misses. _See premium tier for advanced scoring._

**Cascade Amplification Ratio (CAR):**

```
CAR = [cascade formula]. See premium tier for advanced scoring.
```
...
_See premium tier for the full coupling coefficient matrix and dimension sensitivity indices. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._

### 3.1c Cross-Dimensional Coupling Layer

_The coupling layer captures cross-dimensional effects. See premium tier for the formula and scoring weights. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._

### 3.2 Source 1: Objective Telemetry
...
_The coupling matrix reveals optimal intervention targets. See premium tier for Intervention Leverage Score (ILS), cascade intervention patterns, and MEI calculations. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._
...
| Three-Source Health Score | Telemetry + Peer + Self (see premium tier for weights) | Algorithm specification |
