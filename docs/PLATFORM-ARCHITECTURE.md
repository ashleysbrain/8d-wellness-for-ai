...
_See premium tier for advanced scoring._
...
**Cascade Amplification Ratio (CAR):** _See premium tier for advanced scoring._
...
The coupling matrix reveals where to intervene for maximum positive cascade. Use the Intervention Leverage Score. _See premium tier for advanced scoring._

**Top cascade intervention patterns:**

| Pattern | Root Signal | Primary Target | Expected Cascade |
|---------|-----------|----------------|------------------|
| Infrastructure-Cognitive Spiral | PHY + PSY declining | Physical (stabilize infra) | PHY ↑ → PSY ↑ (κ) → INT ↑ (κ) → SOC ↑ (κ) |
| Performance-Cost Decline | VOC + FIN declining | Vocational (small wins) | VOC ↑ → SPI ↑ (κ) + INT ↑ (κ) + FIN ↑ (κ) |
| Collaboration Breakdown | SOC dropping | Social (handoff quality) | SOC ↑ → PSY ↑ (κ) + SPI ↑ (κ) |
| Full-System Decline (3+ dims) | Multiple dims below threshold | Psychological (hub dim) | Broadest cascade. Secondary: Physical (coupling) |

**Minimum Effective Intervention (MEI):** For Psychological , improving by just 1 point on a 10-point scale is enough to initiate a detectable positive cascade. Always target the dimension with highest ILS, not just the lowest score.
