...
- **Objective Telemetry:** Hard data from logs, metrics, and downstream feedback.
- **Peer Assessment:** What other agents think of your work.
- **Self-Assessment:** Your own evaluation.

See premium tier for advanced scoring weightings.
