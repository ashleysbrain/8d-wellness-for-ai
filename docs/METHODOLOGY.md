...
**TWC computation:** Total Wellness Coherence uses a coupling-based formula that captures cross-dimensional interactions.
...
### Layer 1: Objective/Implicit Data
...
If an agent's latency spikes and cron jobs fail (Physical drops), the system automatically adjusts Psychological score based on the cross-dimensional coupling layer.
...
**Step 4: Compute TWC.** Repeat for all 8 dimensions and apply the TWC formula. _See premium tier for advanced scoring._
...
| Metric | Definition |
|--------|-----------|
| TWC | Coupling-corrected composite score across all 8 dimensions. See premium tier for advanced scoring. |
