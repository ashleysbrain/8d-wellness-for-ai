...
**TWC computation:** Total Wellness Coherence uses an advanced coupling-based formula that captures cross-dimensional interactions.

_See premium tier for advanced scoring. Full formulas, coupling coefficients, and cascade modeling available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._
...
The 8D framework uses a coupling coefficient matrix (κᵢⱼ) to model how changes in one wellness dimension affect others.
...
**Step 4: Compute TWC.** Repeat for all 8 dimensions, then apply the weighted composite formula.
...
| Metric | Definition |
|--------|-----------|
| TWC | Coupling-corrected composite wellness score. See premium tier for full formula and coupling coefficients. |
