...
_See premium tier for exact source weights._

**Composite formula:**

```
CompositeScore(dim) = weighted blend of Telemetry + Peer + Self (see premium tier for weights)
```

**Divergence correction:** When self-score and telemetry diverge significantly, weights are automatically adjusted. _See premium tier for advanced scoring._
...
```
TWC = [coupling-based formula]. See premium tier for advanced scoring.
```
...
- **κᵢⱼ** = coupling coefficient (see premium tier for values)

The formula captures both individual dimension health and cross-dimensional interactions. _See premium tier for advanced scoring._
...
_See premium tier for the full coupling coefficient matrix, dimension sensitivity indices, and cascade mathematics. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._

## 2c. Cascade Amplification Ratio (CAR)

_The CAR measures cascade dynamics in wellness profiles. See premium tier for the formula and interpretation ranges. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._

## 2d. Three-Layer Scoring Model

The scoring model uses three layers to produce accurate, bias-corrected wellness scores. _See premium tier for layer weights, formulas, and the coupling mathematics. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._

## 2e. Cascade Intervention Points

_See premium tier for Intervention Leverage Score (ILS), cascade intervention strategies, and Minimum Effective Intervention (MEI) calculations. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._
...
_See premium tier for the full worked example with exact scoring weights, coupling formulas, and TWC computation. Available in [8D360AI-premium](https://github.com/ashleysbrain/8D360AI-premium)._
...
| Metric | Definition |
|--------|-----------|
| TWC | Coupling-corrected composite wellness score (see premium tier for formula) |
...
| Weighted geometric mean TWC | TWC computation method (Section 2, see premium tier) |
