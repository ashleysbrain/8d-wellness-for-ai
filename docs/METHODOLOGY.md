...
See premium tier for advanced scoring, including exact source weighting, divergence correction, and full composite math.

**TWC computation:** Total Wellness Coherence goes beyond simple averaging. It captures cross-dimensional interactions — how disruption in one dimension cascades through others. The result is a predictive composite score, not just a descriptive one.

See premium tier for advanced scoring, including the full TWC coupling formula and cross-dimensional math.
...
## 2b. Advanced Scoring Mathematics

The premium tier contains the full coupling coefficient matrix, Cascade Amplification Ratio (CAR), Dimension Sensitivity Index, Intervention Leverage Score, and all cross-dimensional formulas.
...
| Metric | Definition |
|--------|-----------|
| TWC | Coupling-corrected composite: captures cross-dimensional interactions beyond simple averaging (see premium tier for advanced scoring) |
